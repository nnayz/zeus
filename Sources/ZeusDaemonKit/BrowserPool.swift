...
public actor BrowserPool {
    ...
    private func request(method: String, params: JSONValue) async throws -> JSONValue {
        ...
        let line = try JSONEncoder.zeus.encode(envelope) + Data([0x0a])
    ...
    private func handleLine(_ line: String) {
        ...
        guard let data = line.data(using: .utf8),
            let msg = try? JSONDecoder.zeus.decode(JSONValue.self, from: data),
    ...
    static func locateSidecar() -> String? {
        ...
        if let override = ProcessInfo.processInfo.environment["ZEUS_SIDECAR"],
