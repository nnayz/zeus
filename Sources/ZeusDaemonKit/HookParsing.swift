...
enum HookParsing {
    /// Parses a Claude hook payload (raw stdin JSON forwarded by `zeus hook`).
    ...
    /// Parses a Codex notify payload (single JSON argv forwarded by `zeus notify`).
