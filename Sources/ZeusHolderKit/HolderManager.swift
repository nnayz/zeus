...
public final class HolderManagerServer: @unchecked Sendable {
    ...
    private let workerQueue = DispatchQueue(
        label: "dev.zeus.holder-manager.sessions",
        qos: .userInitiated,
        attributes: .concurrent)
    private let lifecycleQueue = DispatchQueue(label: "dev.zeus.holder-manager.lifecycle")
        ...
        case .launch:
            ...
            workerQueue.async { [weak self] in
                ...
                do {
                    ...
                    let message = Data(
                        "zeusd-holder manager: session \(spec.sessionID): \(error)\n".utf8)
