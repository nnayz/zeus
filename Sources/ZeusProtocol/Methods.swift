...
// MARK: - Hook ingestion (from the zeus CLI helpers)

public struct HookReportParams: Codable, Sendable {
    /// "claude-hook" | "codex-notify"
    public var kind: String
    public var zeusSessionID: SessionID?
    ...
    public init(kind: String, zeusSessionID: SessionID?, event: String?, payload: JSONValue) {
        self.kind = kind
        self.zeusSessionID = zeusSessionID
        self.event = event
        self.payload = payload
    }
}
