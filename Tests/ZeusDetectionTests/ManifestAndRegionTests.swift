...
@Suite struct PredicateTests {
    private func decode(_ json: String) throws -> ZeusDetection.Predicate {
        try JSONDecoder().decode(ZeusDetection.Predicate.self, from: json.data(using: .utf8)!)
    }
