...
@Suite struct ScrollbackWireTests {
    @Test func readScrollbackResultRoundTrips() throws {
        ...
        let data = try JSONEncoder.zeus.encode(result)
        let back = try JSONDecoder.zeus.decode(ReadScrollbackResult.self, from: data)
    ...
    @Test func readScrollbackCellsParamsRoundTrips() throws {
        ...
        let data = try JSONEncoder.zeus.encode(params)
        let back = try JSONDecoder.zeus.decode(ReadScrollbackCellsParams.self, from: data)
    ...
    @Test func readScrollbackCellsResultCarriesCellsThroughSharedCodec() throws {
        ...
        let json = try JSONEncoder.zeus.encode(result)
        let back = try JSONDecoder.zeus.decode(ReadScrollbackCellsResult.self, from: json)
