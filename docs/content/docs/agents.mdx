...
description: The agent catalog, resume behavior, and what the sidebar status colors mean.
---
...
Zeus MCP injected automatically (see [Orchestration](/docs/orchestration)).
