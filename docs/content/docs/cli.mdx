---
title: Command line
description: "The packaged `zeus` CLI for sessions, worktrees, and doctor checks."
---
...
Pair this with [Orchestration](/docs/orchestration) when the lead is another
agent, and with [Fleet patterns](/docs/fleet) when you are the lead.
