---
title: Companion architecture and trust model
description: How the iOS Companion pairs, authenticates, and talks to the Rust gateway.
---
...
or a bootstrap dependency. The [security model](/docs/security-model) still applies.
