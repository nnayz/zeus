---
title: iOS Companion
description: Check Zeus sessions from an iPhone or iPad through the Companion HTTPS gateway.
---
...
[`ios/ZeusCompanion/`](https://github.com/nnayz/zeus/tree/main/ios/ZeusCompanion), inside this repository.
