...
use crate::notifications::{
    APPROVE_ACTION_ID, ActionData, DENY_ACTION_ID, NotificationRequest as ZeusNotification,
    PERMISSION_CATEGORY_ID, SendTextCommand, command_for_action,
};

const ACTION_DATA_KEY: &str = "zeusActionData";
...
impl NativeNotifier {
    ...
    pub fn post(&self, notification: &ZeusNotification) {
...
impl NativeNotifierInner {
    ...
    fn post(&self, notification: &ZeusNotification) {
