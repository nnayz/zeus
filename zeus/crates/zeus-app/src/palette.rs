...
use zeus_proto::{AgentKind, AgentReadinessResult, HostEntry, Project, SessionRecord};
...
pub fn actions_for_default_host(
    ...
    result.extend([
        ...
        PaletteAction {
            id: "review-branches".into(),
            title: "Branches…".into(),
            system_image: "arrow.triangle.branch",
            shortcut: None,
            detail: None,
            enabled: true,
            command: PaletteCommand::OpenBranches,
            keywords: "git branch switch checkout compare review".into(),
        },
        PaletteAction {
            id: "review-goto-pr".into(),
            title: "Go to Pull Request…".into(),
            system_image: "arrow.up.right.square",
            shortcut: None,
            detail: None,
            enabled: true,
            command: PaletteCommand::GoToPullRequest,
            keywords: "git github pr pull request review #".into(),
        },
        PaletteAction {
...
#[cfg(test)]
mod tests {
    use zeus_proto::{AgentDescriptor, AgentReadinessItem, AgentSetup, ProjectId};
    ...
    fn claude_session(host: Option<&str>) -> SessionRecord {
        ...
        SessionRecord {
            ...
            status: zeus_proto::SessionStatus::Idle,
            needs_input: None,
    ...
    fn sessions_match_their_directory_and_branch_as_well_as_their_title() {
        ...
        untitled.id = zeus_proto::SessionId::new("s_2");
        untitled.title = "Untitled".into();
        untitled.cwd = "/work/zeus".into();
        ...
        assert_eq!(ranked[0].item.cwd, "/work/zeus");
