...
impl SidebarPreviewFixture {
    ...
    pub fn make(scenario: PreviewScenario) -> Self {
        ...
        if scenario == PreviewScenario::Artifacts {
            ...
            let pull_request_url = "https://github.com/acme/zeus/pull/63";
...
[Open the implementation notes](https://github.com/acme/zeus/pull/63)"#
                        .into(),
                ),
                ...
                checks: Some(vec![
                    PrCheck {
                        ...
                        url: Some("https://github.com/acme/zeus/actions/runs/103".into()),
                    },
                    PrCheck {
                        name: "Swift tests".into(),
                        result: "pass".into(),
                        detail: Some("SUCCESS".into()),
                        url: Some("https://github.com/acme/zeus/actions/runs/101".into()),
                    },
                    PrCheck {
                        name: "Rust / clippy".into(),
                        result: "pass".into(),
                        detail: Some("SUCCESS".into()),
                        url: Some("https://github.com/acme/zeus/actions/runs/102".into()),
                    },
                ]),
                discussion: Some(vec![
                    PrDiscussionItem {
...
mod tests {
    ...
    fn typical_fixture_carries_a_two_level_spawn_tree() {
        ...
        let group = projection
            .projects
            .iter()
            .find(|group| group.project.id == ProjectId::new("preview-zeus"))
            .expect("the zeus group");
