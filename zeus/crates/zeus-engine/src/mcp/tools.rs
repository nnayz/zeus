...
//!
//! Ported from the Swift `ZeusMCPTools`. The spawnable-agent list is filled
        ...
        tool(
            ...
            json!({
                ...
                "properties": {
                    ...
                    "worktree": { "type": "boolean", "description": "Create a fresh git worktree off cwd and run there." },
