...
const REQUIRED_CAPABILITIES: &[zeus_proto::remote_pty::RemoteCapability] =
...
pub struct RemoteSessionClient {
    ...
    scrollback_requests: Mutex<HashMap<u64, mpsc::Sender<zeus_proto::ReadScrollbackCellsResult>>>,
}
...
impl RemoteSessionClient {
    ...
    pub fn read_scrollback_cells(
        ...
        first_row: i64,
        max_rows: i64,
    ) -> io::Result<zeus_proto::ReadScrollbackCellsResult> {
