...
//! is the same headless-core arrangement and is portable to every platform zeus
//! targets.
//!
...
impl HeadlessScreen {
    ...
    pub fn scrollback(&self) -> zeus_proto::ReadScrollbackResult {
        let grid = self.term.grid();
        ...
        zeus_proto::ReadScrollbackResult {
            lines,
            first_row: 0,
