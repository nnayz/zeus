//! Typed control methods from `ZeusProtocol/Methods.swift`.
...
pub struct HookReportParams {
    pub kind: String,
    #[serde(rename = "zeusSessionID", skip_serializing_if = "Option::is_none")]
    pub zeus_session_id: Option<SessionId>,
    #[serde(skip_serializing_if = "Option::is_none")]
