//! Shared wire model ported from `ZeusCore`.

use serde::{Deserialize, Deserializer, Serialize, Serializer, de};
use serde_json::{Map, Value};
use std::collections::BTreeMap;

/// A Foundation `Date` encoded by Zeus as milliseconds since 1970.
...
///
/// Mirrors `ZeusCore.AgentKind`, which stopped being a closed enum so that
