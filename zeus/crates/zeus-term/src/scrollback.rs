...
use zeus_proto::grid::{GridCell, GridCodecError, GridRowCodec};
use zeus_proto::methods::ReadScrollbackCellsResult;
...
/// the trait here avoids coupling the renderer to `zeus-client` or a runtime.
...
mod tests {
    ...
    use zeus_proto::grid::{GridRowCodec, TermColor, TermStyle};
