                        ...
                        div()
                            ...
                            .child(
                                div()
                                    .text_size(px(15.0))
                                    .font_weight(FontWeight::SEMIBOLD)
                                    .child("zeus · design system gallery"),
                            )
                            .child(
                                div()
                                    .text_size(px(11.0))
...
fn main() {
    application()
        .with_assets(zeus_ui::IconAssets)
        .run(|cx: &mut App| {
            ...
            cx.open_window(
                WindowOptions {
                    ...
                    titlebar: Some(TitlebarOptions {
                        title: Some("zeus-ui gallery".into()),
            ...
            .expect("failed to open zeus-ui gallery");
            cx.activate(true);
        });
}
