...
/// Optical sizes for zeus's shared 24×24 line icons.
///
...
/// The shared, platform-independent icon vocabulary for zeus.
///
...
impl IconName {
    ...
    /// All names currently used by zeus resolve to the shared SVG vocabulary.
...
/// A tintable SVG icon from zeus's shared 24×24 icon family.
#[derive(IntoElement)]
pub struct Icon {
    name: IconName,
    size: f32,
...
/// Render a legacy platform-symbol name through zeus's SVG icon family.
