...
//! and every install is stranded until people redownload by hand. zeus leans
...
Executable=/Applications/zeus.app/Contents/MacOS/zeus
Identifier=com.zeus.zeus
Format=app bundle with Mach-O universal (x86_64 arm64)
CodeDirectory v=20500 size=1234 flags=0x10000(runtime) hashes=30+7
Signature size=9012
Authority=Developer ID Application: Nasrul Huda (AH8WARWU6L)
...
"#;
    ...
    const AD_HOC: &str = r#"
Executable=/Users/giga/fun/zeus/zeus/dist/zeus.app/Contents/MacOS/zeus
Identifier=com.zeus.zeus
Format=app bundle with Mach-O universal (x86_64 arm64)
Signature=adhoc
...
"#;
    ...
    fn parses_a_developer_id_signature() {
        ...
        assert_eq!(info.identifier.as_deref(), Some("com.zeus.zeus"));
    ...
    fn accepts_a_download_from_the_same_team_and_identifier() {
        ...
        assert!(check_identity(&found, "AH8WARWU6L", Some("com.zeus.zeus")).is_ok());
    }
    ...
    fn rejects_a_notarized_app_from_a_different_developer() {
        ...
        let error = check_identity(&other, "AH8WARWU6L", Some("com.zeus.zeus"))
    ...
    fn rejects_an_ad_hoc_download_even_with_the_right_identifier() {
        ...
        assert!(check_identity(&found, "AH8WARWU6L", Some("com.zeus.zeus")).is_err());
    }
