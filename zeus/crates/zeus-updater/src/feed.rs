//! The update feed zeus fetches from the releases host.
//!
//! JSON rather than a Sparkle appcast: nothing in zeus parses XML, and the
...
//!     {
//!       "version": "0.2.0",
//!       "url": "https://github.com/nnayz/zeus/releases/download/v0.2.0/zeus-0.2.0-universal.zip",
//!       "size": 48210944,
//!       "sha256": "5f2e…",
//!       "minimum_system_version": "15.0",
//!       "published": "2026-07-26",
//!       "notes_url": "https://github.com/nnayz/zeus/releases/download/v0.2.0/zeus-0.2.0.html"
//!     }
//!   ]
//! }
//! ```
...
pub struct Release {
    pub version: String,
    /// Zip of the notarized, stapled `zeus.app` — not the DMG. See
...
mod tests {
    ...
    fn release(version: &str) -> Release {
        Release {
            ...
            url: format!("https://example.test/zeus-{version}.zip"),
            ..Release::default()
        }
    }
    ...
    /// Byte-for-byte shape of what `zeus/scripts/release.sh` writes. If the
  ...
  "releases": [
    ...
    {
      "version": "0.1.0",
      "url": "https://github.com/nnayz/zeus/releases/download/v0.2.0/zeus-0.1.0-universal.zip",
      "size": 48102400,
...
"#,
        ...
        assert!(offered.url.ends_with("zeus-0.2.0-universal.zip"));
