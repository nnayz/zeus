# Zeus GPUI macOS patch

This directory is copied from `zed-industries/zed` revision
`dc2a339d5d043da448a3f7ddc7c0a85c63864aad`, crate `gpui_macos`.

Zeus's patch makes the renderer's full-window path and 4x MSAA textures lazy.
Normal Zeus scenes use quads, glyph sprites, and CoreGraphics-rasterized brand
...
that pinned revision. Bundling it keeps ordinary Zeus builds reproducible on
